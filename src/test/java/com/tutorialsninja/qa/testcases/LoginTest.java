...
public class LoginTest extends BaseClass{
	//make driver public so that listerner interface can acces it screenshots code
	...
	public void setUP() {
		...
		loginPageObj=homepageobj.selectLoginOption();
	}
	...
	public void verifyLoginWithInvalidEmailAndValidPassword() {
		//removed login page obejct declariotn to remove code
